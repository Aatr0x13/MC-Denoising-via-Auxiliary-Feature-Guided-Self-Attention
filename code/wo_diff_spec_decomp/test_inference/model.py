...
class AFGSA(nn.Module):
    def __init__(self, ch, block_size=16, halo_size=5, num_heads=4, bias=False):
    ...
    def forward(self, noisy, aux):
        ...
        # b*#blocks*#heads, flattened_, head_ch
...
class TransformerBlock(nn.Module):
    def __init__(self, ch, block_size=16, halo_size=5, num_heads=4, checkpoint=True):
...
class AFGSANet(nn.Module):
    def __init__(self, in_ch, aux_in_ch, base_ch, num_sa=5, block_size=8, halo_size=3, num_heads=4, num_gcp=2):
        ...
        self.conv_a3 = conv_block(aux_in_ch, 256, kernel_size=3, padding=1, padding_mode='reflect',
                                  act_type='leakyrelu')
        self.conv_a5 = conv_block(aux_in_ch, 256, kernel_size=5, padding=2, padding_mode='reflect',
                                  act_type='leakyrelu')
